...
class EncodeTester():
    ...
    def test(self, tar_fnames, tar_mask_fnames, save_tri=True, trace_output_path=None, onnx_output_path=None):
        device = self.device
...
def main():
    ...
    parser.add_argument(
        "-o", dest="onnx_output_path", type=str, default=None, help="Path for saving the TorchScript model."
    )
    ...
    tester.test(tgt_fnames, tgt_mask_fnames, onnx_output_path=configargs.onnx_output_path)
